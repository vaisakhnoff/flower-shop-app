    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex border-b border-gray-200 mb-8">
        ...
        <button
          ...
          onClick={() => { setActiveTab('categories'); setShowAddProduct(false); }}
        >
          Categories
        </button>
      </div>
      ...
      {activeTab === 'categories' && (
        <div>
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
              + Add New Category
            </button>
          </div>
