...
export default function AdminPanelPage() {
  ...
  // Data Fetching
  const { products, isLoading: productsLoading, hasMore: productsHasMore, loadMore: loadMoreProducts } = useProducts(undefined);
          ...
          {!showAddProduct ? (
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  onClick={() => { setProductToEdit(null); setShowAddProduct(true); }}
                        ...
                        {products.map((product) => (
                          <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="p-4 font-medium text-gray-900">
                              {product.name}
                              {/* Show language badge if translations exist */}
                              {product.name_ml && (
            ...
            <div>
              <button 
                onClick={() => { setShowAddProduct(false); setProductToEdit(null); }}
          ...
          {!showAddCategory ? (
             <>
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  onClick={() => { setCategoryToEdit(null); setShowAddCategory(true); }}
                  className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors"
                >
                  + Add New Category
                </button>
            ...
            <div>
              <button 
                onClick={() => { setShowAddCategory(false); setCategoryToEdit(null); }}
                className="mb-4 text-gray-600 hover:text-gray-800 flex items-center"
              >
                ← Back to List
              </button>
